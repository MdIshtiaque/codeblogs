<nav class="side-nav">
    ...
    <ul>
        <li>
            <a href="{{ route('dashboard.dashboard') }}" class="side-menu {{ request()->is('admin/dashboard') ? 'side-menu--active' : '' }}">
        ...
        <li>
            <a href="{{ route('post.post') }}" class="side-menu {{ request()->is('admin/post') ? 'side-menu--active' : '' }}">
